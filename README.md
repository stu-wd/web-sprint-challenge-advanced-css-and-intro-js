...
<!-- The internet needs to be made for everyone, so building websites that can be used by anyone is crucial. Accessibility tells the e-reader more about your page and the individual elements that exist on the page -->

2. Talk about 3 different things you can do to ensure your website is accessible.

<!-- Making sure your website is keyboard friendly - this means utitilizing the hover state :focus

Adding alt text to images

Using color and schemes carefully -->

3. How would you explain the concept of a variable to someone new to programming?

<!-- A variable is something that I want to use and reference in code. We can use 3 different ways to create a variable and assign a value to it. -->

4. What is the purpose of using functions in code?

<!-- Like Pace said, they are little blocks of code. It allows the programmer to tell the computer to do things at different iterations or due to conditional statements. It helps to save a ton of space and time. -->
